...
# PyInstaller command: pyinstaller -F camberUIDialogNew.py -n "Camber Disc Golf Background Removal Tool" --icon=camberShirtLogo.png  --add-data "u2net.onnx;." --add-data "camberShirtLogo.png;."
